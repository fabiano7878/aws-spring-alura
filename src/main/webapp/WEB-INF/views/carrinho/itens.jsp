    ...
    <table id="cart-table">
      ...
      <tbody>
        <c:forEach items="${carrinhoCompras.itens }" var="item">
	        <tr>
	          <td class="cart-img-col"><img src="${item.produto.sumarioPath}" width="143" height="202"/>	          
	          <%-- 
	          Para uso com o TomCat 
	          <img src="<c:url value="/resources/imagens/${item.produto.sumarioPath}"/>" width="143" height="202" /> 
	          --%>
