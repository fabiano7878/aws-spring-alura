...
public class RedisConfiguration extends AbstractHttpSessionApplicationInitializer{
	 ...
	 * JedisPoolConfig pool = new JedisPoolConfig(); JedisConnectionFactory factory
	 * = new JedisConnectionFactory(pool); factory.setHostName("localhost");
	...
	public JedisConnectionFactory jedisConnectionFactory() {
		...
		factory.setHostName("seu endereço do redis na amazonaws.com");
